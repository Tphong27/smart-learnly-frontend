...
export function TraineeHeader({ user, onLogout, roleLabel }) {
    ...
    useEffect(() => {
        if (!categoriesOpen && !notificationOpen && !profileOpen)
            return undefined;

        function closeMenus(event) {
            const outsideCategories = !categoriesRef.current?.contains(
                event.target,
            );
                    ...
                    <div className="trainee-header__menu-anchor">
                        ...
                        >
                            {user?.avatarUrl ? (
                                ...
                                <span className="trainee-header__avatar">
                                    {initials}
                                </span>
                            )}
