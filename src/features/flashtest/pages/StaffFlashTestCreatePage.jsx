    ...
    useEffect(() => {
        ...
        async function loadCourses() {
            try {
                ...
                const courseItems = Array.isArray(data?.items)
                    ? data.items
                    : [];
                if (!cancelled) {
                    setCourses(
                        courseItems.filter((course) => getCourseId(course)),
                    );
                }
            } catch (error) {
                    ...
                    {testType === "essay" ? (
                        <>
                            ...
                            <label className="ft-field">
                                ...
                                <span className="ft-muted">
                                    AI lists a separate, clearly labelled rubric for each generated assignment.
                                </span>
                                <textarea
                        ...
                        <>
                            ...
                            <div className="ft-field">
                                ...
                                <div className="ft-radio-group" role="radiogroup" aria-label="Test status">
