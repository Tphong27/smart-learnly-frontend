...
export function StaffFlashTestCreatePage({ variant = "flash" }) {
  ...
  const pageName = isAssignmentMode
    ? "Assignment"
    : isFlashMode
      ? "Flash Test"
      : "Test";
  const [testType, setTestType] = useState(
    isFlashMode || isAssignmentMode ? "essay" : "mcq",
  );
      ...
      <header className="ft-builder-hero">
        <div className="ft-builder-hero__content">
          <span className="ft-page-kicker">
            {isAssignmentMode ? "" : isFlashMode ? "Flash Tests" : "Tests"}
          </span>
        ...
        <div className="ft-ribbon" aria-label={`${pageName} setup summary`}>
          <div className="ft-ribbon__item">
            ...
            <div>
              ...
              <span>
                {testType === "essay" ? "Essay assignment" : "MCQ practice"}
              </span>
            </div>
          </div>
          <div className="ft-ribbon__item">
          ...
          <div className="ft-ribbon__item">
            ...
            <div>
              <strong>
                {testType === "mcq" ? "Questions" : "Instructions"}
              </strong>
              <span>
                {testType === "mcq"
          ...
          {testType === "essay" ? (
            <>
              ...
              <AssignmentAiDraftPanel
                ...
                onDraftGenerated={({ rubric }) => updateFormData({ rubric })}
              />

              <label className="ft-field">
                <span className="ft-label">Assignment rubrics</span>
                <span className="ft-muted">
                  AI lists a separate, clearly labelled rubric for each
            ...
            <>
              <label className="ft-field">
                ...
                <select
                  ...
                  onChange={(event) => {
                    updateFormData({ moduleId: event.target.value });
                    setSelectedQuestions([]);
                  }}
              ...
              <div className="ft-field">
                ...
                <div
                  className="ft-radio-group"
                  role="radiogroup"
                  aria-label="Test status"
                >
                  <label className="ft-radio-option">
                    <input
                      type="radio"
                      name="test-status"
                      checked={formData.isPublished}
                      onChange={() => updateFormData({ isPublished: true })}
                    />
                    <span>Active</span>
                  </label>
                  <label className="ft-radio-option">
                    <input
                      ...
                      name="test-status"
                      checked={!formData.isPublished}
                      onChange={() => updateFormData({ isPublished: false })}
                    />
                    <span>Inactive</span>
                  </label>
                </div>
