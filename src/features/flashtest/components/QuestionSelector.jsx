...
export function QuestionSelector({
  ...
  const loadQuestions = useCallback(async () => {
    ...
    try {
      ...
      setQuestions([]);
      setLoadError(error?.message || "Could not load questions for this course.");
    } finally {
      setLoading(false);
    }
  }, [courseId, moduleId]);
    ...
    <div className="ft-question-selector">
      <div className="ft-question-bank-header">
        <span className="ft-muted">
          {availableQuestions.length} available / {selectedQuestions.length} selected
        </span>
        <button
            ...
            {availableQuestions.map((question) => {
              ...
              return (
                <div className="ft-question-row-wrap" key={id}>
                  ...
                  {expandedQuestionId === id && renderAnswerPreview(question)}
                </div>
              );
            })}
          </div>
