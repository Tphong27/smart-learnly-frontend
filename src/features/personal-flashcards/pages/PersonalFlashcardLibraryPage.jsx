...
export function PersonalFlashcardLibraryPage() {
            ...
            personalFlashcardService
                ...
                .catch((loadError) => {
                    ...
                    setError(
                        getErrorMessage(
                            loadError,
                            "Unable to load your flashcard sets.",
                        ),
                    );
                })
                .finally(() => {
    ...
    return (
        <section className="personal-flashcards-page">
            ...
            <section
                className="personal-flashcards-panel"
                aria-label="Personal flashcard library"
            >
                <div className="personal-flashcards-toolbar" role="search">
                    ...
                    />
                    <label
                        className="personal-flashcards-toolbar__sort"
                        htmlFor="personal-flashcard-sort"
                    >
                        <span>
                            <ArrowDownUp size={16} aria-hidden="true" /> Sort by
                        </span>
                        <select
                    ...
                    <div className="personal-flashcard-empty-state">
                        <h2>
                            {hasSearch
                                ...
                                : "No personal flashcard sets yet"}
                        </h2>
                        <p>
                            {hasSearch
                                ? "Try another title or clear the search."
                                : "Create a set to start building your own study library."}
                        </p>
                        {hasSearch ? (
                            <Button
                                variant="secondary"
