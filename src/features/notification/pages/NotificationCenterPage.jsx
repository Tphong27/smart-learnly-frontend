    ...
    return (
        ...
        >
            ...
            >
                ...
                {preview && (
                    <span className="notifications-list-item__preview">
                        {preview}
                    </span>
                )}
            </button>
...
export function NotificationCenterPage() {
        ...
        setPageState((current) => {
            ...
            return {
                ...
                items: updateNotification(
                    current.items,
                    notification.id,
                    (item) => withNotificationRead(item, timestamp),
                ),
            };
        });
    ...
    async function handleArchive(notification) {
        ...
        try {
            ...
            setPageState(previousState);
            setActionError(
                getErrorMessage(error, "Failed to archive notification."),
            );
        }
    }
    ...
    return (
        ...
        >
            <div className="notifications-page__header">
                ...
                <div className="notifications-page__header-actions">
                    <button
                        ...
                        className="notifications-action"
                        disabled={
                            unreadCount === 0 || isBulkMutating("read-all")
                        }
            ...
            <div className="notifications-toolbar">
                <div
                    className="notifications-filter-group"
                ...
                <>
                    <div className="notifications-list">
                        {pageState.items.map((notification) => (
                            <NotificationListItem
                                ...
                                mutating={isNotificationMutating(
                                    notification.id,
                                )}
                    ...
                    <div className="notifications-pagination">
                        <span>
                            ...
                            {Math.max(1, totalPages)} - {pageState.totalItems}{" "}
                            notifications
                        </span>
                        <div>
                            <button
