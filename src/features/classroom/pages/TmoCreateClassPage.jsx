                    ...
                    <div className="form-section">
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                className={
                                    form.errors.className ? "input-error" : ""
                                }
                            />
                        ...
                        <div className="form-group">
                            ...
                            <select
                                ...
                                className={
                                    form.errors.courseId ? "input-error" : ""
                                }
                            >
                        ...
                        <div className="form-group">
                            ...
                            <select
                                ...
                                className={
                                    form.errors.trainerId ? "input-error" : ""
                                }
                            >
                    ...
                    <div className="form-section">
                        ...
                        <div className="form-row">
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    className={
                                        form.errors.endDate ? "input-error" : ""
                                    }
                                />
                                {form.errors.endDate && (
                                    <span className="form-error-text">
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                className={
                                    form.errors.maxStudents ? "input-error" : ""
                                }
                            />
