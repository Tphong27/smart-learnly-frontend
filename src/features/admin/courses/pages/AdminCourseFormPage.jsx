...
const STATUS_OPTIONS = [
    {
        value: "draft",
        label: "Draft",
        description: "Only course staff can access and continue editing it.",
    },
    {
        value: "published",
        label: "Published",
        description:
            "The course can be used when creating and managing classes.",
    },
    {
        value: "inactive",
        label: "Inactive",
        description:
            "The course is hidden from new class setup until reactivated.",
    },
];
...
/** Tạo payload metadata course; học phí được quản lý ở cấp lớp học. */
        ...
        async function loadActiveSmes() {
            ...
            try {
                ...
                if (!cancelled) {
                    setSmeOptions([]);
                    toast.error(
                        error?.message || "Could not load active SME accounts.",
                    );
                }
            } finally {
                if (!cancelled) {
            ...
            >
                ...
                <div className="sl-course-editor__layout">
                    ...
                    <aside className="sl-course-editor__aside">
                        ...
                        >
                            <div className="sl-course-editor__section-header">
                                ...
                                <div>
                                    ...
                                    <p>
                                        Use a clear 16:9 image without small
                                        text.
                                    </p>
                                </div>
                            </div>
                        ...
                        <section
                            className="sl-course-editor__section sl-course-editor__section--aside sl-course-editor__status-section"
                        ...
                        >
                            <div className="sl-course-editor__section-header">
                                ...
                                <div>
                                    <h2 id="course-status-heading">
                                        Course status
                                    </h2>
                                    <p>
                                        Control whether this course can be used
                                        for classes.
                                    </p>
                                </div>
                            </div>

                            <div className="sl-course-editor__status-content">
                                {isEdit ? (
                                    <Select
                                        id="course-status"
                                        className="sl-course-field--full"
