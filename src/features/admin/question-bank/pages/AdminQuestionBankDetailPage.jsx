...
function normalizeQuestionMedia(question) {
    ...
    const images = sortedAttachments.filter(
        (item) =>
            String(item.mediaType || "").toLowerCase() === "image" &&
            mediaUrl(item),
    );
    const audios = sortedAttachments.filter(
        (item) =>
            String(item.mediaType || "").toLowerCase() === "audio" &&
            mediaUrl(item),
    );
                ...
                >
                    ...
                    >
                        ...
                        <div style={{ flex: 1 }}>
                            ...
                            >
                                All questions and media are read-only. Restore
                                the bank to make changes again.
                            </p>
                            {writable && (
                                <Button
                                    size="sm"
                        ...
                        <>
                            ...
                            <Pagination
                                ...
                                totalPages={Math.max(
                                    1,
                                    Math.ceil(
                                        activityTotalItems / ACTIVITY_PAGE_SIZE,
                                    ),
                                )}
