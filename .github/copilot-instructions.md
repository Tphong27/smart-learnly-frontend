...
- Do not reintroduce neo-brutalism, offset black shadows, hover translation, decorative gradients, glassmorphism, emoji icons, or colorful icon boxes.
- Reuse shared UI components, global tokens, and `lucide-react`.
- Preserve unrelated changes and run targeted ESLint plus `npm run build` for frontend edits.
